...
// Essa função será utilizada no update do filme,pois precisa apagar todos os geeros relacionados com o filme para inserir as novas relações
const deleteGeneroByIDFilme = async function (idFilme) {
